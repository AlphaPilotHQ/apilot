...
from apilot.trader.constant import Direction, Offset, Interval, Status
from apilot.trader.database import get_database, BaseDatabase
from apilot.trader.object import OrderData, TradeData, BarData
from apilot.trader.utility import round_to, extract_vt_symbol
from apilot.trader.optimize import (
    OptimizationSetting,
    run_ga_optimization
)
...
class BacktestingEngine:
    ...
    def run_bf_optimization(
        ...
        """暴力穷举优化"""
        raise NotImplementedError("run_bf_optimization is not implemented")

    run_optimization = run_ga_optimization
